...
#pragma region GAME::PrepareResources
...
#pragma region Game::CreateBackBuffer
...
#pragma region TriangleComponent::Initialize
	...
	if (FAILED(res)) {
		...
		{
			MessageBox(hWnd, L"MyShader.hlsl", L"Missing Shader File", MB_OK);
		}
	...
	res = D3DCompileFromFile(L"../Shaders/MyShader.hlsl", Shader_Macros /*macros*/, nullptr /*include*/, "PSMain", "ps_5_0", D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION, 0, &pixelBC, &errorPixelCode);
